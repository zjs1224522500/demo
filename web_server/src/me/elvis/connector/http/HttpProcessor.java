...
import me.elvis.connector.ServletProcessor;
import me.elvis.connector.StaticResourceProcessor;
...
public class HttpProcessor {
  ...
  protected StringManager sm =
    StringManager.getManager("me.elvis.connector.http");

  /**
   * 对请求传入的套接字进行相关处理;<br/>
   * 1、创建相应的HttpRequest对象和HttpResponse对象；<br/>
   * 2、解析HTTP请求的第一行内容和请求头信息，填充HttpRequest对象<br/>
   * 3、根据URI对不同类型的请求进行相应的处理。
   * @param socket 套接字
   */
